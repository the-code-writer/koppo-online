...
export const createCollapsibleSection = (name: string, label: string, fields: StrategyField[]): StrategyField => ({
  name,
  label,
...
export const createStandardTabs = (strategySpecificFields: StrategyField[]): StrategyTab[] => [
  {
    key: "contract",
    label: "Contract",
  ...
  },
  {
    ...
    label: "Advanced",
    fields: [
      createCollapsibleSection("general_settings_section", "General Settings", COMMON_FIELDS.generalSettings),
      createCollapsibleSection("bot_schedule_section", "Bot Schedule", COMMON_FIELDS.botSchedule),
      createCollapsibleSection("risk_management_section", "Risk Management", COMMON_FIELDS.riskManagement),
      createCollapsibleSection("volatility_controls_section", "Volatility Controls", COMMON_FIELDS.volatilityControls),
      createCollapsibleSection("market_conditions_section", "Market Conditions", COMMON_FIELDS.marketConditions),
      createCollapsibleSection("recovery_settings_section", "Recovery Settings", COMMON_FIELDS.recoverySettings),
...
export const STRATEGY_PARAMS: Record<string, FormConfig> = {
  [StrategyType.MARTINGALE]: {
    tabs: createStandardTabs([
      createCollapsibleSection("martingale_strategy_section", "Martingale Settings", [
        {
  ...
  [StrategyType.DALEMBERT]: {
    tabs: createStandardTabs([
      createCollapsibleSection("dalembert_strategy_section", "D'Alembert Strategy Settings", [
        {
  ...
  [StrategyType.REVERSE_MARTINGALE]: {
    tabs: createStandardTabs([
      createCollapsibleSection("reverse_martingale_strategy_section", "Reverse Martingale Strategy Settings", [
        {
  ...
  [StrategyType.OPTIONS_DALEMBERT]: {
    tabs: createStandardTabs([
      createCollapsibleSection("options_dalembert_section", "Options D'Alembert Settings", [
        {
  ...
  [StrategyType.DALEMBERT_ON_STAT_RESET]: {
    tabs: createStandardTabs([
      createCollapsibleSection("dalembert_reset_strategy_section", "D'Alembert on Stat Reset Settings", [
        {
          name: "dalembert_reset_frequency",
          label: "Reset Frequency (trades)",
          type: "number" as FieldType,
  ...
  [StrategyType.REVERSE_DALEMBERT]: {
    tabs: createStandardTabs([
      createCollapsibleSection("reverse_dalembert_strategy_section", "Reverse D'Alembert Strategy Settings", [
        {
  ...
  [StrategyType.REVERSE_DALEMBERT_ON_STAT_RESET]: {
    tabs: createStandardTabs([
      createCollapsibleSection("reverse_dalembert_reset_strategy_section", "Reverse D'Alembert on Stat Reset Settings", [
        {
  ...
  [StrategyType.OPTIONS_MARTINGALE]: {
    tabs: createStandardTabs([
      createCollapsibleSection("options_martingale_section", "Options Martingale Settings", [
        {
          name: "options_contract_type",
          label: "Contract Type",
          type: "select" as FieldType,
  ...
  [StrategyType.OPTIONS_REVERSE_MARTINGALE]: {
    tabs: createStandardTabs([
      createCollapsibleSection("options_reverse_martingale_section", "Options Reverse Martingale Settings", [
        {
  ...
  [StrategyType.OPTIONS_OSCARS_GRIND]: {
    tabs: createStandardTabs([
      createCollapsibleSection("oscars_grind_strategy_section", "Options Oscar's Grind Settings", [
        {
  ...
  [StrategyType.OPTIONS_1326_SYSTEM]: {
    tabs: createStandardTabs([
      createCollapsibleSection("system_1326_strategy_section", "Options 1-3-2-6 System Settings", [
        {
  ...
  [StrategyType.OSCARS_GRIND]: {
    tabs: createStandardTabs([
      createCollapsibleSection("oscars_grind_strategy_section", "Oscar's Grind Settings", [
        {
  ...
  [StrategyType.SYSTEM_1326]: {
    tabs: createStandardTabs([
      createCollapsibleSection("system_1326_strategy_section", "1-3-2-6 System Settings", [
        {
  ...
  [StrategyType.MARTINGALE_ON_STAT_RESET]: {
    tabs: createStandardTabs([
      createCollapsibleSection("martingale_reset_strategy_section", "Martingale on Stat Reset Settings", [
        {
