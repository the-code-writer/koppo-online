...
import { MessageOutlined, GoogleOutlined, WalletOutlined, LinkOutlined, CheckCircleFilled, UserOutlined, MailOutlined, CalendarOutlined, ClockCircleOutlined, LinkOutlined as LinkIcon, TagsOutlined, DollarCircleOutlined, GlobalOutlined } from "@ant-design/icons";
import "./styles.scss";
...
export function LinkedAccountsSettingsDrawer({ visible, onClose, user }: ProfileSettingsDrawerProps) {
  ...
  const connectedAccounts = derivAccounts.map((account: any) => ({
    id: account.id,
    type: 'deriv',
  ...
  // Wrapper function for updateAccountStatus with notifications
  const handleUpdateAccountStatus = async (accountId: string, status: 'active' | 'disabled') => {
          ...
          <div className="tokens-grid">
            ...
            >
              ...
              <div className="account-card-body">
                ...
                {/* Deriv Login Button - Only show when not linked */}
                ...
                {connectedAccounts.length > 0 && (
                  <>
                    ...
                    <div className="account-details" onClick={() => setAccountsDrawerVisible(true)}>
                      {fullAccount && (<>
                        <Flex justify="space-between" align="center" style={{ marginBottom: 8 }}>
                          ...
                          <code>{fullAccount.fullname || 'Deriv User'}</code>
                        </Flex>
                        <Divider style={{ margin: '12px 0' }} />
                        <Flex justify="space-between" align="center" style={{ marginBottom: 8 }}>
                          <Flex align="center" gap={8}>
                            <MailOutlined style={{ color: '#dc4446', fontSize: 14 }} />
                            <Text strong>Email</Text>
                          </Flex>
                          <code className="email-text" style={{
                            maxWidth: '200px',
                        ...
                        <Flex justify="space-between" align="center" style={{ marginBottom: 8 }}>
                          ...
                          <code>{fullAccount.userId || 'N/A'}</code>
                        </Flex>
                        <Divider style={{ margin: '12px 0' }} />
                        <Flex justify="space-between" align="center" style={{ marginBottom: 8 }}>
                          <Flex align="center" gap={8}>
                            <WalletOutlined style={{ color: '#dc4446', fontSize: 14 }} />
                            <Text strong>Login/Account ID</Text>
                          </Flex>
                          <code>{fullAccount.loginId || 'N/A'}</code>
                        </Flex>
                        <Divider style={{ margin: '12px 0' }} />
                        <Flex justify="space-between" align="center" style={{ marginBottom: 8 }}>
                          <Flex align="center" gap={8}>
                            <DollarCircleOutlined style={{ color: '#dc4446', fontSize: 14 }} />
                            <Text strong>Currency</Text>
                          </Flex>
                          <code>{fullAccount.currency || 'N/A'}</code>
                        </Flex>
                        <Divider style={{ margin: '12px 0' }} />
                        <Flex justify="space-between" align="center" style={{ marginBottom: 8 }}>
                          <Flex align="center" gap={8}>
                            <CalendarOutlined style={{ color: '#dc4446', fontSize: 14 }} />
                            <Text strong>Linked Time</Text>
                          </Flex>
                          <code>{fullAccount.accountLinkedTime ? new Date(fullAccount.accountLinkedTime).toLocaleDateString() : 'Unknown'}</code>
                        </Flex>
                        <Divider style={{ margin: '12px 0' }} />
                        <Flex justify="space-between" align="center" style={{ marginBottom: 8 }}>
                          <Flex align="center" gap={8}>
                          ...
                          <code>{fullAccount.createdAt ? new Date(fullAccount.createdAt * 1000).toLocaleDateString() : 'Unknown'}</code>
                        </Flex>
                        <Divider style={{ margin: '12px 0' }} />
                        <Flex justify="space-between" align="center" style={{ marginBottom: 8 }}>
                          <Flex align="center" gap={8}>
                            <GlobalOutlined style={{ color: '#dc4446', fontSize: 14 }} />
                            <Text strong>Country</Text>
                          </Flex>
                          <code>{fullAccount.country}</code>
                        </Flex>
                ...
                >
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', width: '100%' }}>
                    <div style={{ flex: 1 }}>
                      ...
                      <div key={account.id} style={{ marginTop: 24, padding: 0, backgroundColor: 'transparent', borderRadius: 8 }}>
                        <Flex justify="space-between" align="center" style={{ marginBottom: 8, paddingBottom: 8, borderBottom: '1px dotted rgba(217, 217, 217, 0.5)' }}>
                          <Flex align="center" gap={8}>
                            <WalletOutlined style={{ color: '#dc4446', fontSize: 14 }} />
                        ...
                        <Flex justify="space-between" align="center" style={{ marginBottom: 8, paddingBottom: 8, borderBottom: '1px dotted rgba(217, 217, 217, 0.5)' }}>
                          ...
                          <code>{!(account as any).isVirtual ? 'Real Money' : 'Demo'}</code>
                        </Flex>
                        <Flex justify="space-between" align="center" style={{ marginBottom: 8, paddingBottom: 8, borderBottom: '1px dotted rgba(217, 217, 217, 0.5)' }}>
                          <Flex align="center" gap={8}>
                            <WalletOutlined style={{ color: '#dc4446', fontSize: 14 }} />
                        ...
                        <Flex justify="space-between" align="center" style={{ marginBottom: 8, paddingBottom: 8, borderBottom: '1px dotted rgba(217, 217, 217, 0.5)' }}>
                          <Flex align="center" gap={8}>
                            <WalletOutlined style={{ color: '#dc4446', fontSize: 14 }} />
                            <Text strong>Currency Type</Text>
                          </Flex>
                          <code>{(account as any).currencyType || 'Standard'}</code>
                        </Flex>
                        <Flex justify="space-between" align="center" style={{ marginBottom: 8, paddingBottom: 8, borderBottom: '1px dotted rgba(217, 217, 217, 0.5)' }}>
                          <Flex align="center" gap={8}>
                            <CalendarOutlined style={{ color: '#dc4446', fontSize: 14 }} />
                          ...
                          <code>{(account as any).createdAt ? new Date((account as any).createdAt * 1000).toLocaleDateString() : 'Unknown'}</code>
                        </Flex>
                        <Flex justify="space-between" align="center" style={{ marginBottom: 8, paddingBottom: 8, borderBottom: '1px dotted rgba(217, 217, 217, 0.5)' }}>
                          <Flex align="center" gap={8}>
                            <WalletOutlined style={{ color: '#dc4446', fontSize: 14 }} />
                        ...
                        <Flex justify="space-between" align="center" style={{ marginBottom: 8, paddingBottom: 8, borderBottom: '1px dotted rgba(217, 217, 217, 0.5)' }}>
                          <Flex align="center" gap={8}>
                            ...
                            <Text strong>Is Virtual</Text>
                          </Flex>
                          <code>{(account as any).isVirtual ? 'Yes' : 'No'}</code>
                        </Flex>
                        <Flex justify="space-between" align="center" style={{ marginBottom: 8, paddingBottom: 8, borderBottom: '1px dotted rgba(217, 217, 217, 0.5)' }}>
                          <Flex align="center" gap={8}>
                            <LinkIcon style={{ color: '#dc4446', fontSize: 14 }} />
                            <Text strong>Is this account active?</Text>
                          </Flex>
                          <Switch
                            checked={(account.status || 'active') === 'active'}
                            onChange={(checked) => handleUpdateAccountStatus(account.id, checked ? 'active' : 'disabled')}
                            size="small"
                          />
                        </Flex>
                        <Space className="feature-tags" style={{ marginTop: 14 }}>
