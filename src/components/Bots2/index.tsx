          ...
          <Row gutter={[16, 16]}>
            ...
            return (
              <Col xs={24} sm={24} md={12} lg={12} xl={12} key={bot._id}>
                <Card 
                  className={`bot-card ${bot.status === 'running' ? 'running' : ''}`}
                  hoverable
                  size="small"
                >
                  {/* Card Header */}
                  ...
                  <div className="bot-controls">
                    <div className="control-buttons">
                      ...
                      <Tooltip title={bot.status === 'running' ? 'Bot is running' : 'Start Bot'}>
                        <Button
                      ...
                      <Tooltip title={bot.status !== 'running' ? 'Bot is not running' : 'Pause Bot'}>
                        <Button
                      ...
                      <Tooltip title={bot.status === 'stopped' ? 'Bot is already stopped' : 'Stop Bot'}>
                        <Button
