...
const StrategiesList = ({ strategies, onSelectedStrategy }: { 
  ...
  return (
    <div className="strategy-selection-sheet">
      <div className="strategy-selection-header">
        <h3>Select a Strategy</h3>
        <Text type="secondary">Choose a template to configure your new trading bot</Text>
      </div>
      <div className="strategy-selection-list">
        {strategies.map((strategy: StrategyItem) => (
          <div
            key={strategy._id}
            className="strategy-selection-item"
            onClick={() => onSelectedStrategy(strategy)}
          >
            <div className="strategy-selection-icon-wrapper">
              <Avatar 
            ...
            <div className="strategy-selection-content">
              <div className="strategy-selection-title">
                {strategy.configuration.general.botName}
              </div>
              <div className="strategy-selection-desc">
                {strategy.description.length > 60 
                  ? `${strategy.description.substring(0, 60)}...` 
                  : strategy.description}
              </div>
              <div className="strategy-selection-tags">
                <Tag color="blue" bordered={false}>{strategy.configuration.general.market}</Tag>
                <Tag color="purple" bordered={false}>{strategy.configuration.general.tradeType}</Tag>
              </div>
            </div>
            <div className="strategy-selection-arrow">
        ...
        <Row justify="space-between" align="middle" gutter={[32, 16]}>
          <Col xs={24} sm={24} md={12} lg={12} xl={12}>
            <div className="header-title-section">
              <h1>Bots <Badge count={botList.length} showZero /></h1>
                    ...
                    >
                      ...
                      <div className="bot-stats">
                        ...
                        <div className="stat-item">
                          ...
                          <div className="stat-content">
                            <span className="stat-value">{bot.baseStake}</span>
                          </div>
                        </div>
                        <div className="stat-item">
                          <div className="stat-icon">
