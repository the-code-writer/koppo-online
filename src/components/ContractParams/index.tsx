...
export function ContractParams({ defaultValues, updateStep, onContractParamsChange }: ContractParamsProps) {
  ...
  const updateContractParams = (field: keyof ContractData, value: any) => {
    setContractParams({ ...contractParams, [field]: value });
    updateStep(defaultValues.id, field, value);
  };

  useEffect(()=>{
    if(typeof onContractParamsChange === 'function'){
      onContractParamsChange(contractParams);
    }
    console.log("CONTRACT_PARAMS_CHANGE", contractParams, defaultValues)
  },[contractParams])
  return (
          ...
          <Flex justify='space-between' align='center'>
            ...
            <span>Random Market
              <Switch
                ...
                value={contractParams.marketRandomize}
          ...
          <Flex justify='space-between' align='center'>
            ...
            <span>Random Integer
              <Switch className="switch" size="small" style={{marginLeft: 12, marginTop: -3}}
                value={contractParams.predictionRandomize}
